...
"use strict";var aff_id=$('meta[name="aff_id"]').attr("content");$(document).ready((function(){setCookiesLogIpv4(),setCookiesLogIpv6()}));var setCookiesLogIpv4=function(){$.ajax({url:"https://apirvp4."+conf.logip+"/sw/collect?aff_id="+aff_id,dataType:"json",success:function(o,t){},error:function(o,t,a){}})},setCookiesLogIpv6=function(){$.ajax({url:"https://apirvp6."+conf.logip+"/sw/collect?aff_id="+aff_id,dataType:"json",success:function(o,t){},error:function(o,t,a){}})};